...
backendフォルダの下に main/main.go を作成します。
```
% pwd
/Users/.../Documents/console_202501/backend/main
% go mod init github.com/ryoyuki6/console_202501/backend/main 
go: creating new go.mod: module console_202501/backend/main
...
次に、backendフォルダの下に handler/router.go を作成します。

```
% pwd
/Users/.../Documents/console_202501/backend/handler
% go mod init github.com/ryoyuki6/console_202501/backend/handler
go: creating new go.mod: module github.com/ryoyuki6/console_202501/backend/handler
go: to add module requirements and sums:
	go mod tidy
% go mod tidy
% ls
...
```
% pwd
/Users/ryo/Documents/console_202501/backend/main
% go mod edit -replace=github.com/ryoyuki6/console_202501/backend/handler=../handler
% go get github.com/ryoyuki6/console_202501/backend/handler
go: downloading github.com/ryoyuki6/console_202501 v0.0.0-20241227233432-d0642c891d8e
go: added github.com/ryoyuki6/console_202501/backend/handler v0.0.0-00010101000000-000000000000
```
